...
%             handles_choices.resume_processing=handles.resume_processing;
            ...
            % handles_choices.no_sub_ROIs=handles.no_sub_ROIs;
            % handles_choices.no_runs__per_sub_ROI=handles.no_runs__per_sub_ROI;

            % handles_choices.save_path_conc=handles.save_path_conc;
            % handles_choices.generate_idx=handles.generate_idx;
            % handles_choices.save_tag_conc=handles.save_tag_conc;
            ...
            for ii_run=first_run:length(handles.bins_before)
                ...
                if handles.overwrite_output==1
                    ...
                    if exist([handles_choices.save_path handles_choices.arena_file(1:end-4) handles_choices.save_tag '_subROI.mat'],'file')==2
                        process_data=0;
                    else
                        process_data=1;
                    end
                ...
                if process_data==1
                    ...
                    handles_out=drgMini_DecodeOdorArena_SingleROI_gpu(handles_choices);

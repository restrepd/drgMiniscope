function handles_out=drgMini_AnalyzePathv4(handles_choices)
...
if exist('handles_choices')==0
    ...
    handles_choices.save_tag='aangles';
    ...
    handles_choices.display_figures=1;
else

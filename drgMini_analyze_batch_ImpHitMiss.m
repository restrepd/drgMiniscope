%drgMini_analyze_batch_ImpHitMiss
%
...
switch is_sphgpu
    case 0
        ...
        save_PathMoser='/Users/restrepd/Documents/Projects/SFTP/Fabio_OdorArena_GoodData/Moser_hit_miss08182025/';
        choiceMoserFileName='drgMiniMoserChoices_HitMiss_08182025.m';
...
all_spatial_rho_hit_vs_miss=[];
all_delta_center_of_mass=[];
all_information_content=[];
all_information_content_hit=[];
all_information_content_miss=[];
all_information_content_sh=[];
all_information_content_hit_sh=[];
all_information_content_miss_sh=[];
all_sparsity=[];
conc_spatial_rho_hit_vs_miss=[];
conc_delta_center_of_mass=[];
conc_information_content=[];
conc_sparsity=[];
x_spatial_rho_hit_vs_miss=[];
x_delta_center_of_mass=[];
x_information_content=[];
x_sparsity=[];
y_spatial_rho_hit_vs_miss=[];
...
for fileNo=1:length(handles_conc.arena_file)
    if (sum(handles_conc.group(fileNo)==these_groups)>0)&(files_included(fileNo)==1)
        ...
        % imps.file(fileNo).spatial_rho_hit_vs_miss=handles_out.spatial_rho_hit_vs_miss;
        ...
        all_spatial_rho_hit_vs_miss=[all_spatial_rho_hit_vs_miss; handles_out.spatial_rho_hit_vs_miss];
        ...
        all_information_content_hit=[all_information_content_hit; handles_out.information_content_hit];
        all_information_content_miss=[all_information_content_miss; handles_out.information_content_miss];
        all_information_content_sh=[all_information_content_sh; handles_out.sh_information_content(:)];
        all_information_content_hit_sh=[all_information_content_hit_sh; handles_out.sh_information_content_hit(:)];
        all_information_content_miss_sh=[all_information_content_miss_sh; handles_out.sh_information_content_miss(:)];
        all_sparsity=[all_sparsity; handles_out.sparsity];

        imps.file(fileNo).spatial_rho_hit_vs_miss=handles_out.spatial_rho_hit_vs_miss;
        imps.file(fileNo).delta_center_of_mass=handles_out.delta_center_of_mass;
        imps.file(fileNo).information_content=handles_out.information_content;
        imps.file(fileNo).information_content_hit=handles_out.information_content_hit;
        imps.file(fileNo).information_content_miss=handles_out.information_content_miss;
        imps.file(fileNo).sh_information_content=handles_out.sh_information_content;
        imps.file(fileNo).sh_information_content_hit=handles_out.sh_information_content_hit;
        imps.file(fileNo).sh_information_content_miss=handles_out.sh_information_content_miss;
        imps.file(fileNo).sparsity=handles_out.sparsity;
        imps.all_spatial_rho_hit_vs_miss=all_spatial_rho_hit_vs_miss;
        imps.all_delta_center_of_mass=all_delta_center_of_mass;
        imps.all_Fusi_SSI=all_information_content;
        imps.all_Fusi_SSIl4=all_information_content_miss;
        imps.all_Fusi_SSIl1=all_information_content_hit;
        imps.all_Fusi_SSI_sh=all_information_content_sh;
        imps.all_Fusi_SSIl4_sh=all_information_content_miss_sh;
        imps.all_Fusi_SSIl1_sh=all_information_content_hit_sh;


        conc_spatial_rho_hit_vs_miss=[conc_spatial_rho_hit_vs_miss; handles_out.spatial_rho_hit_vs_miss((mean_conc_imps>=thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))];
        ...
        x_spatial_rho_hit_vs_miss=[x_spatial_rho_hit_vs_miss; handles_out.spatial_rho_hit_vs_miss((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps>=thr_x_imps(fileNo)))];
        ...
        y_spatial_rho_hit_vs_miss=[y_spatial_rho_hit_vs_miss; handles_out.spatial_rho_hit_vs_miss((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps>=thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))];

...
switch is_sphgpu
    case 0
        ...
        fileID = fopen([choiceBatchPathName 'decode_XYandconc_SingleROI_stats.txt'],'w');
...
these_r2ERs=handles_anal_conc.these_r2ERs_conc(logical(handles_anal_conc.these_sig_conc));
glm_r2ER.data(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=these_r2ERs;
% glm_r2ER.ROIsubset(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=ROIsubset*ones(1,length(these_r2ERs));
glm_r2ER.group(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=1*ones(1,length(these_r2ERs));
glm_r2ER_ii=glm_r2ER_ii+length(these_r2ERs);
...
these_r2ERs=handles_anal_XY.these_r2ERs_x(logical(handles_anal_XY.these_sig_x));
glm_r2ER.data(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=these_r2ERs;
% glm_r2ER.ROIsubset(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=ROIsubset*ones(1,length(these_r2ERs));
glm_r2ER.group(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=2*ones(1,length(these_r2ERs));
glm_r2ER_ii=glm_r2ER_ii+length(these_r2ERs);

id_r2ER_ii=id_r2ER_ii+1;
input_r2ER_data(id_r2ER_ii).data=these_r2ERs;
input_r2ER_data(id_r2ER_ii).description='x';
...
these_r2ERs=handles_anal_XY.these_r2ERs_x(logical(handles_anal_XY.these_sig_y));
glm_r2ER.data(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=these_r2ERs;
% glm_r2ER.ROIsubset(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=ROIsubset*ones(1,length(these_r2ERs));
glm_r2ER.group(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=3*ones(1,length(these_r2ERs));
glm_r2ER_ii=glm_r2ER_ii+length(these_r2ERs);

id_r2ER_ii=id_r2ER_ii+1;
input_r2ER_data(id_r2ER_ii).data=these_r2ERs;
input_r2ER_data(id_r2ER_ii).description='y'
...
%Perform the glm  for prediction of odor all, hit, miss, shuffled
fprintf(1, ['\nglm for Fig ' num2str(figureNo) ' for significant r2ER for odor, x and y\n']);
% fprintf(1, ['\n1 Hit, 2 All, 3 Miss, 4 Shuffled\n']);
fprintf(fileID, ['\nglm for Fig ' num2str(figureNo) ' for significant r2ER for odor, x and y\n']);
% fprintf(fileID, ['\n1 Hit, 2 All, 3 Miss, 4 Shuffled\n']);
...
tbl = table(glm_r2ER.data',glm_r2ER.group',...
    'VariableNames',{'r2ES','group'});
mdl = fitglm(tbl,'r2ES~group'...
    ,'CategoricalVars',[2])
...
%Do the ranksum/t-test
fprintf(1, ['\n\nRanksum or t-test p values for significant r2ER for odor, x and y\n'])
fprintf(fileID, ['\n\nRanksum or t-test p values for significant r2ER for odor, x and y\n']);
...
%Now find out whether those with mixed selectiiy yield higher r2ERs for
%odor

these_sig_mixed=(logical(handles_anal_conc.these_sig_conc)&logical(handles_anal_XY.these_sig_x))....
    |(logical(handles_anal_conc.these_sig_conc)&logical(handles_anal_XY.these_sig_y));
...
%x selective
these_r2ERs=these_r2ERs_conc(logical(handles_anal_XY.these_sig_x)&(~these_sig_mixed));
...
glm_r2ER.data(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=these_r2ERs;
% glm_r2ER.ROIsubset(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=ROIsubset*ones(1,length(these_r2ERs));
glm_r2ER.group(glm_r2ER_ii+1:glm_r2ER_ii+length(these_r2ERs))=4*ones(1,length(these_r2ERs));
glm_r2ER_ii=glm_r2ER_ii+length(these_r2ERs);

id_r2ER_ii=id_r2ER_ii+1;
input_r2ER_data(id_r2ER_ii).data=these_r2ERs;
input_r2ER_data(id_r2ER_ii).description='x selective';

%y selective
these_r2ERs=these_r2ERs_conc(logical(handles_anal_XY.these_sig_y)&(~these_sig_mixed));
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
id_r2ER_ii=id_r2ER_ii+1;
input_r2ER_data(id_r2ER_ii).data=these_r2ERs;
input_r2ER_data(id_r2ER_ii).description='y selective';

%odor selective
these_r2ERs=these_r2ERs_conc(logical(handles_anal_conc.these_sig_conc)&(~these_sig_mixed));
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
id_r2ER_ii=id_r2ER_ii+1;
input_r2ER_data(id_r2ER_ii).data=these_r2ERs;
input_r2ER_data(id_r2ER_ii).description='odor selective';

%mixed selectivity
these_r2ERs=these_r2ERs_conc(these_sig_mixed);
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
id_r2ER_ii=id_r2ER_ii+1;
input_r2ER_data(id_r2ER_ii).data=these_r2ERs;
input_r2ER_data(id_r2ER_ii).description='mixed selectivity';


%Perform the glm  for prediction of odor all, hit, miss, shuffled
fprintf(1, ['\nglm for Fig ' num2str(figureNo) ' for r2ER for odor vs selectivity\n']);
% fprintf(1, ['\n1 Hit, 2 All, 3 Miss, 4 Shuffled\n']);
fprintf(fileID, ['\nglm for Fig ' num2str(figureNo) ' for r2ER for odor vs selectivity\n']);
% fprintf(fileID, ['\n1 Hit, 2 All, 3 Miss, 4 Shuffled\n']);

fprintf(1, ['\n1 Mixed selectivity, 2 Odor-selective, 3 y-selective, 4 x-selective\n']);
fprintf(fileID, ['\n1 Mixed selectivity, 2 Odor-selective, 3 y-selective, 4 x-selective\n']);
...
%Do the ranksum/t-test
fprintf(1, ['\n\nRanksum or t-test p values for r2ER odor vs selectivity\n'])
fprintf(fileID, ['\n\nRanksum or t-test p values for r2ER odor vs selectivity\n']);
...
xticks([0:3])
xticklabels({'x selective','y selective','odor selective','mixed selectivity'})
xtickangle(45)

xlim([-1 4])
ylim([0 0.3])
ylabel('r2ER OC')
title('Dependence of r2ER OC on selectivity')

%Mixed selectivity for x and y
these_sig_mixed=(logical(handles_anal_XY.these_sig_y)&logical(handles_anal_XY.these_sig_x));


%Now find out whether those with mixed selectivity yield higher r2ERs for x
figureNo=figureNo+1;
try
    close(figureNo)
catch
...
%x selective
these_r2ERs=these_r2ERs_x(logical(handles_anal_XY.these_sig_x)&(~these_sig_mixed));
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
%y selective
these_r2ERs=these_r2ERs_x(logical(handles_anal_XY.these_sig_y)&(~these_sig_mixed));
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
%odor selective
these_r2ERs=these_r2ERs_x(logical(handles_anal_conc.these_sig_conc)&(~these_sig_mixed));
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
%mixed selectivity
these_r2ERs=these_r2ERs_x(these_sig_mixed);
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
%Do the ranksum/t-test
fprintf(1, ['\n\nRanksum or t-test p values for r2ER x vs selectivity\n'])
fprintf(1, ['\n1 Mixed selectivity, 2 Odor-selective, 3 y-selective, 4 x-selective\n']);
fprintf(fileID, ['\n\nRanksum or t-test p values for r2ER x vs selectivity\n']);
fprintf(fileID, ['\n1 Mixed selectivity, 2 Odor-selective, 3 y-selective, 4 x-selective\n']);
...
ylim([0 0.3])
ylabel('r2ER x')
title('Dependence of r2ER x on selectivity')


%Now find out whether those with mixed selectivity yield higher r2ERs for y
figureNo=figureNo+1;
try
    close(figureNo)
catch
...
%x selective
these_r2ERs=these_r2ERs_y(logical(handles_anal_XY.these_sig_x)&(~these_sig_mixed));
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
%y selective
these_r2ERs=these_r2ERs_y(logical(handles_anal_XY.these_sig_y)&(~these_sig_mixed));
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
%odor selective
these_r2ERs=these_r2ERs_y(logical(handles_anal_conc.these_sig_conc)&(~these_sig_mixed));
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
%mixed selectivity
these_r2ERs=these_r2ERs_y(these_sig_mixed);
bar(bar_offset,mean(these_r2ERs),'LineWidth', 3,'EdgeColor','none','FaceColor',[230/255 159/255 0/255])
...
ylim([0 0.3])
ylabel('r2ER y')
title('Dependence of r2ER y on selectivity')

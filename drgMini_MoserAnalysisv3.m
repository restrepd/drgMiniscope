function handles_out=drgMini_MoserAnalysisv3(handles_choices)
...
dr_information_contentl1=zeros(no_neurons,1); %Mutual information between binary dFF and xy
dr_information_contentl4=zeros(no_neurons,1);
dr_information_contentl_mutual_1l4=zeros(no_neurons,1);

sh_dr_information_contentl1=zeros(no_neurons,n_shuffle_SI); %Mutual information between binary dFF and xy
sh_dr_information_contentl4=zeros(no_neurons,n_shuffle_SI);
sh_dr_information_contentl_mutual_1l4=zeros(no_neurons,n_shuffle_SI);
        ...
        if sum(p_xy_bindFF_Lane1(:,ii_xy))>0
            for ii_bin_dFF=1:2
                if p_xy_bindFF_Lane1(ii_bin_dFF,ii_xy)~=0
                    dr_information_contentl1(this_ROI)=dr_information_contentl1(this_ROI)+p_xy_bindFF_Lane1(ii_bin_dFF,ii_xy)*...
        ...
        if sum(p_xy_bindFF_Lane4(:,ii_xy))>0
            for ii_bin_dFF=1:2
                if p_xy_bindFF_Lane4(ii_bin_dFF,ii_xy)~=0
                    dr_information_contentl4(this_ROI)=dr_information_contentl4(this_ROI)+p_xy_bindFF_Lane4(ii_bin_dFF,ii_xy)*...
            ...
            for ii_lane=1:2
                for ii_bin_dFF=1:2
                    if p_xy_bindFF_lane(ii_bin_dFF,ii_xy,ii_lane)~=0
                        dr_information_contentl_mutual_1l4(this_ROI)=dr_information_contentl_mutual_1l4(this_ROI)+p_xy_bindFF_lane(ii_bin_dFF,ii_xy,ii_lane)*...
    ...
    for ii_sh=1:n_shuffle_SI
        ...
        for ii_xy=1:10*10
            if sum(p_xy_bindFF_Lane1(:,ii_xy))>0
                for ii_bin_dFF=1:2
                    if p_xy_bindFF_Lane1(ii_bin_dFF,ii_xy)~=0
                        sh_dr_information_contentl1(this_ROI,ii_sh)=sh_dr_information_contentl1(this_ROI,ii_sh)+p_xy_bindFF_Lane1(ii_bin_dFF,ii_xy)*...
                            log2(p_xy_bindFF_Lane1(ii_bin_dFF,ii_xy)/(p_xy_Lane1(ii_xy)*p_bindFF_Lane1(ii_bin_dFF)));
                    end
                end
            end
        ...
        for ii_xy=1:10*10
            if sum(p_xy_bindFF_Lane4(:,ii_xy))>0
                for ii_bin_dFF=1:2
                    if p_xy_bindFF_Lane4(ii_bin_dFF,ii_xy)~=0
                        sh_dr_information_contentl4(this_ROI,ii_sh)=sh_dr_information_contentl4(this_ROI,ii_sh)+p_xy_bindFF_Lane4(ii_bin_dFF,ii_xy)*...
                            log2(p_xy_bindFF_Lane4(ii_bin_dFF,ii_xy)/(p_xy_Lane4(ii_xy)*p_bindFF_Lane4(ii_bin_dFF)));
                    end
                end
            end
        ...
        for ii_xy=1:10*10
            if sum(p_xy_bindFF_Lane4(:,ii_xy))>0
                for ii_lane=1:2
                    for ii_bin_dFF=1:2
                        if p_xy_bindFF_lane(ii_bin_dFF,ii_xy,ii_lane)~=0
                            sh_dr_information_contentl_mutual_1l4(this_ROI,ii_sh)=sh_dr_information_contentl_mutual_1l4(this_ROI,ii_sh)+p_xy_bindFF_lane(ii_bin_dFF,ii_xy,ii_lane)*...
                                log2(p_xy_bindFF_lane(ii_bin_dFF,ii_xy,ii_lane)/(p_xy(ii_xy)*p_bindFF(ii_bin_dFF)*p_lane(ii_lane)));
                        end
                    end
                end
...
handles_out.dr_information_contentl1=dr_information_contentl1;
handles_out.dr_information_contentl4=dr_information_contentl4;
handles_out.dr_information_contentl_mutual_1l4=dr_information_contentl_mutual_1l4;
handles_out.sh_dr_information_contentl1=sh_dr_information_contentl1;
handles_out.sh_dr_information_contentl4=sh_dr_information_contentl4;
handles_out.sh_dr_information_contentl_mutual_1l4=sh_dr_information_contentl_mutual_1l4;

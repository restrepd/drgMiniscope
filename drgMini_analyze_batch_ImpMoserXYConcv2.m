...
for fileNo=1:length(handles_conc.arena_file)
    if (sum(handles_conc.group(fileNo)==these_groups)>0)&(files_included(fileNo)==1)
        ...
        these_ssi_all_info_lane1=handles_outic.ssi_all_info_lane1(handles_outic.fileNo==fileNo);
        conc_ssi_all_info_lane1=[conc_ssi_all_info_lane1; these_ssi_all_info_lane1((mean_conc_imps>=thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))'];
        x_ssi_all_info_lane1=[x_ssi_all_info_lane1; these_ssi_all_info_lane1((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps>=thr_x_imps(fileNo)))'];
        y_ssi_all_info_lane1=[y_ssi_all_info_lane1; these_ssi_all_info_lane1((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps>=thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))'];

        these_ssi_all_info_lane4=handles_outic.ssi_all_info_lane4(handles_outic.fileNo==fileNo);
        conc_ssi_all_info_lane4=[conc_ssi_all_info_lane4; these_ssi_all_info_lane4((mean_conc_imps>=thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))'];
        x_ssi_all_info_lane4=[x_ssi_all_info_lane4; these_ssi_all_info_lane4((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps>=thr_x_imps(fileNo)))'];
        y_ssi_all_info_lane4=[y_ssi_all_info_lane4; these_ssi_all_info_lane4((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps>=thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))'];

        these_ssi_all_info_both_lanes=handles_outic.ssi_all_info_both_lanes(handles_outic.fileNo==fileNo);
        conc_ssi_all_info_both_lanes=[conc_ssi_all_info_both_lanes; these_ssi_all_info_both_lanes((mean_conc_imps>=thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))'];
        x_ssi_all_info_both_lanes=[x_ssi_all_info_both_lanes; these_ssi_all_info_both_lanes((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps>=thr_x_imps(fileNo)))'];
        y_ssi_all_info_both_lanes=[y_ssi_all_info_both_lanes; these_ssi_all_info_both_lanes((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps>=thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))'];

        these_ssi_all_info_op_bin=handles_outic.ssi_all_info_op_bin(handles_outic.fileNo==fileNo);
        conc_ssi_all_info_op_bin=[conc_ssi_all_info_op_bin; these_ssi_all_info_op_bin((mean_conc_imps>=thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))'];
        x_ssi_all_info_op_bin=[x_ssi_all_info_op_bin; these_ssi_all_info_op_bin((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps<thr_y_imps(fileNo))&(mean_x_imps>=thr_x_imps(fileNo)))'];
        y_ssi_all_info_op_bin=[y_ssi_all_info_op_bin; these_ssi_all_info_op_bin((mean_conc_imps<thr_conc_imps(fileNo))&(mean_y_imps>=thr_y_imps(fileNo))&(mean_x_imps<thr_x_imps(fileNo)))'];

        these_idxssi=zeros(1,length(these_ssi_all_info_op_bin));
        these_ROIs=1:length(these_ssi_all_info_op_bin);
...
[f_aic,x_aic] = drg_ecdf(handles_outic.ssi_all_info_both_lanes);
plot(x_aic,f_aic,'Color',[0.7 0.7 0.7],'LineWidth',3)

[f_aic,x_aic] = drg_ecdf(conc_ssi_all_info_both_lanes);
plot(x_aic,f_aic,'Color',[0 0.6 0.5],'LineWidth',3)

[f_aic,x_aic] = drg_ecdf(x_ssi_all_info_both_lanes);
plot(x_aic,f_aic,'Color',[0.9 0.6 0],'LineWidth',3)

[f_aic,x_aic] = drg_ecdf(y_ssi_all_info_both_lanes);
plot(x_aic,f_aic,'Color',[0.35 0.7 0.9],'LineWidth',3)

title('MI place and bDF/F both lanes')
xlabel('MI')
...
[f_aic,x_aic] = drg_ecdf(handles_outic.ssi_all_info_op_bin);
plot(x_aic,f_aic,'Color',[0.7 0.7 0.7],'LineWidth',3)

[f_aic,x_aic] = drg_ecdf(conc_ssi_all_info_op_bin);
plot(x_aic,f_aic,'Color',[0 0.6 0.5],'LineWidth',3)

[f_aic,x_aic] = drg_ecdf(x_ssi_all_info_op_bin);
plot(x_aic,f_aic,'Color',[0.9 0.6 0],'LineWidth',3)

[f_aic,x_aic] = drg_ecdf(y_ssi_all_info_op_bin);
plot(x_aic,f_aic,'Color',[0.35 0.7 0.9],'LineWidth',3)

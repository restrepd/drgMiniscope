function handles_out=drgMini_DecodeDynamicOdorConcSingleROIs(handles_choices)
...
if exist('handles_choices')==0
    ...
    bins_before=2; %How many bins of neural data prior to the output are used for decoding, 10

%drgMini_differential_response_per_ROI2
close all
clear all
...
these_ylim=ylim;
these_xlim=xlim;
text(0.2,0.7,'SI Lane 1','Color',[230/255 159/255 0/255],'FontWeight','bold','FontSize',16)
text(0.2,0.65,'SI Lane 4','Color',[86/255 180/255 233/255],'FontWeight','bold','FontSize',16)
text(0.2,0.60,'MI shared by lanes 1 and 4','Color',[0/255 158/255 115/255],'FontWeight','bold','FontSize',16)
text(0.2,0.55,'Odor spout info','Color',[240/255 228/255 66/255],'FontWeight','bold','FontSize',16)
...
xlabel('t-SNE Component 1');
ylabel('t-SNE Component 2');
title(['t-SNE Information Content with mutual lanes, space and dFF' ]);

%Now do tsne analysis with all_info_lane
data2 = [all_info_lane1; all_info_lane4; all_info_lane]; %; all_info_mutual_info14
...
% mappedX = tsne(data, 'NumPCAComponents', 2, 'Perplexity', 30);
% mappedX = tsne(data,'Algorithm','exact','Distance','mahalanobis'); %Works well
mappedXl = tsne(data2,'Algorithm','exact','Distance','euclidean'); %works better
...
xlabel('t-SNE Component 1');
ylabel('t-SNE Component 2');
title(['t-SNE Information Content for lanes, space' ]);
...
gml = fitgmdist(mappedXl, 3); % Assuming 3 clusters
...
title('Cumulative histograms lane info')
xlabel('Information bits')
ylabel('Fraction')
...
xlabel('t-SNE Component 1');
ylabel('t-SNE Component 2');
title(['t-SNE Information Content including lanes,prediction importance ' ]);

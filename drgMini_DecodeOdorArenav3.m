...
percentExplained_x = drgMini_calculateVarianceExplained(XYtest(:,1), x_predicted_conv);
percentExplained_y = drgMini_calculateVarianceExplained(XYtest(:,2), y_predicted_conv);
fprintf(1, 'Percent variance predicted nn conv x, y entire run %d %d\n\n',percentExplained_x,percentExplained_y);

percentExplainedXY = drgMini_calculateVarianceExplainedXY(XYtest(:,1),XYtest(:,2),x_predicted_conv, y_predicted_conv);
...
percentExplained_x = drgMini_calculateVarianceExplained(x_all_trials, x_decod_all_trials);
percentExplained_y = drgMini_calculateVarianceExplained(y_all_trials, y_decod_all_trials);
fprintf(1, 'Percent variance predicted nn conv x, y within trials %d %d\n\n',percentExplained_x,percentExplained_y);

percentExplainedXY = drgMini_calculateVarianceExplainedXY(x_all_trials,y_all_trials,x_decod_all_trials, y_decod_all_trials);
fprintf(1, 'Percent variance predicted nn conv XY within trials %d %d\n\n',percentExplainedXY);

percentExplained_x = drgMini_calculateVarianceExplained(x_between_trials, x_decod_between_trials);
percentExplained_y = drgMini_calculateVarianceExplained(y_between_trials, y_decod_between_trials);
fprintf(1, '\n\nPercent variance predicted nn conv x, y between trials %d %d\n\n',percentExplained_x,percentExplained_y);

percentExplainedXY = drgMini_calculateVarianceExplainedXY(x_between_trials,y_between_trials,x_decod_between_trials, y_decod_between_trials);
fprintf(1, 'Percent variance predicted nn conv XY between trials %d %d\n\n',percentExplainedXY);

percentExplained_x = drgMini_calculateVarianceExplained(x_all_trials_sh, x_decod_all_trials_sh);
percentExplained_y = drgMini_calculateVarianceExplained(y_all_trials_sh, y_decod_all_trials_sh);
fprintf(1, '\n\nPercent variance predicted nn permuted x, y within trials %d %d\n\n',percentExplained_x,percentExplained_y);

percentExplainedXY = drgMini_calculateVarianceExplainedXY(x_all_trials_sh,y_all_trials_sh,x_decod_all_trials_sh, y_decod_all_trials_sh);
fprintf(1, 'Percent variance predicted nn permuted XY within trials %d %d\n\n',percentExplainedXY);

percentExplained_x = drgMini_calculateVarianceExplained(x_between_trials_sh, x_decod_between_trials_sh);
percentExplained_y = drgMini_calculateVarianceExplained(y_between_trials_sh, y_decod_between_trials_sh);
fprintf(1, '\n\nPercent variance predicted nn permuted x, y between trials %d %d\n\n',percentExplained_x,percentExplained_y);

percentExplainedXY = drgMini_calculateVarianceExplainedXY(x_between_trials_sh,y_between_trials_sh,x_decod_between_trials_sh, y_decod_between_trials_sh);
fprintf(1, 'Percent variance predicted nn permuted XY between trials %d %d\n\n',percentExplainedXY);
